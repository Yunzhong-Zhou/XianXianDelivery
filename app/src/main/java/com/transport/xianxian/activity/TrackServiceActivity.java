 ...
 * 轨迹上报示例
 */
public class TrackServiceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView = findViewByID_My(R.id.activity_track_service_map);
        ...
        startTrackView = findViewByID_My(R.id.activity_track_service_start_track);
        startGatherView = findViewByID_My(R.id.activity_track_service_start_gather);
        updateBtnStatus();
        // 服务启停
    ...
    private void updateBtnStatus() {
        ...
        startTrackView.setBackgroundResource(isServiceRunning ? R.drawable.yuanjiao_5_lanse1 : R.drawable.yuanjiao_5_baise);
        startGatherView.setText(isGatherRunning ? "停止采集" : "开始采集");
        startGatherView.setTextColor(isGatherRunning ? 0xFFFFFFFF : 0xFF000000);
        startGatherView.setBackgroundResource(isGatherRunning ? R.drawable.yuanjiao_5_lanse1 : R.drawable.yuanjiao_5_baise);
    }
