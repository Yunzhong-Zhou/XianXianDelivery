 ...
 * description：温层 adapter
 */
public class TemperatureAdapter extends BaseAdapter {
    private Context context;
    private List<TemperatureModel.TemperatureListBean> list;
    private int selectIndex = 0;

    public TemperatureAdapter(Context context, List<TemperatureModel.TemperatureListBean> list) {
        super();
